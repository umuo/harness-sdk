...
final class EditTool {
    ...
    static Tool create(WorkspacePathResolver paths,
        ...
        return Tools.sync(definition, (arguments, context) -> {
            ...
            String oldString = arguments.requireString("old_string");
            String newString = arguments.requireString("new_string");
            boolean replaceAll = arguments.optionalBoolean("replace_all").orElse(false);
